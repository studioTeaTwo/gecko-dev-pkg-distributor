    ...
    browser.runtime.onMessage.addListener(request => {
        ...
        if (["nostr/builtinNip07Init", "nostr/builtinNip07Changed"].includes(action)) {
            ...
            if (data) {
                ...
                window.wrappedJSObject.nip07Loaded = cloneInto(Array.isArray(window.wrappedJSObject.nip07Loaded)
                ...
                window.wrappedJSObject.nip07Loaded = Array.isArray(window.wrappedJSObject.nip07Loaded)
...
const NostrProvider = new window.Object();
...
NostrProvider.signEvent = exportFunction(event => {
    ...
    return new window.Promise(resolve => {
        ...
        window.wrappedJSObject.ssi.nostr.getPublicKey(null, exportFunction(pubkey => {
            console.log("pubkey", pubkey);
            signedEvent.pubkey = pubkey;
            eventHash = (0, utils_1.bytesToHex)((0, sha256_1.sha256)(new TextEncoder().encode(serializeEvent(signedEvent))));
            window.wrappedJSObject.ssi.nostr.sign(JSON.stringify(signedEvent), cloneInto({
                type: "signEvent",
            }, window), exportFunction(signature => {
