 ...
 * @module
 */
import { abytes } from "resource://ssi/protocols/ciphers/_assert.sys.mjs";
import {
  ghash,
  polyval,
} from "resource://ssi/protocols/ciphers/_polyval.sys.mjs";
import {
  clean,
  complexOverlapBytes,
  concatBytes,
  ...
  u8,
  wrapCipher,
} from "resource://ssi/protocols/ciphers/utils.sys.mjs";
const BLOCK_SIZE = 16;
